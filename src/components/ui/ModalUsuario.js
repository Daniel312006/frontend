...
export default function ModalUsuario({ titulo, metodo, elemento, change }) {
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="modalUsuarioLabel">{titulo}</h5>
                    ...
                    <div className="modal-body text-start">
                        <form onSubmit={nuevoElemento}>                            
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" id="nombre" name="nombre" value={elemento.nombre} onChange={handleChange} required/>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="email" className="col-form-label">Correo electrónico:</label>
                                <input type="email" className="form-control" id="email" name="email" value={elemento.email} onChange={handleChange} required/>
                            </div>
                            <div className="mb-3">
